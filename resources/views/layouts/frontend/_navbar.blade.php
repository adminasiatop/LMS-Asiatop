<header class="navbar navbar-expand-lg shadow-5-strong flex-row">
    <div class="container-md">
        ...
        <a href="/" class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pr-0 pr-md-3 mt-2">
            <h2 class="font-weight-bold text-azure"><img src="{{ url('/assets/images/logo.png') }}" height="50"></h2>
        </a>
                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link {{ Route::is('landing') ? 'active' : '' }}" href="/">
                                ...
                                <span class="nav-link-title" style="color:darkslategrey">
                                    Home
                                </span>
                            </a>
                        </li>
        ...
        <div class="navbar-nav flex-row order-md-last">
            @guest
                <a href="{{ route('login') }}" class="login nav-item mr-2 btn "
                    style="--bs-btn-padding-y: .20rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .50rem;">Login</a>
