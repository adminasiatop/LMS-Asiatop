                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            height="10" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
            <ul class="navbar-nav pt-lg-3">
                @role('admin|instructor')
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('admin.karyawan*') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('admin.divisi*') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('admin.identifikasicoaching*') ? 'active' : '' }}"
                            href="{{ route('admin.identifikasicoaching.index') }}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block mr-1">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-tags"
                                    width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
                                    stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <span class="nav-link-title">
                                Identifikasi Coaching
                            </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('admin.coaching*') ? 'active' : '' }}"
                            href="{{ route('admin.coaching.index') }}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block mr-1">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-playlist"
                                    width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
                                    stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
