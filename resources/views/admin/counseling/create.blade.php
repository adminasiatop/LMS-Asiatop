        ...
        <div class="col-12">
            <x-card.card title="Form Counseling">
                <form action="{{ route('admin.counseling.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    {{-- <div class="row">
                        <div class="col-3">
                            <x-form.textarea type="text" title="Goal" name="goal" value="Goal" placeholder="Goal" />
                        </div>
                        <div class="col-3">
                            <x-form.textarea type="text" title="Reality" name="reality" value="Reality" placeholder="Reality" />
                        </div>
                        <div class="col-3">
                            <x-form.textarea type="text" title="Options" name="opsi" value="Options" placeholder="Options" />
                        </div>
                        <div class="col-3">
                            <x-form.textarea type="text" title="Will" name="will" value="Will" placeholder="Will" />
                        </div>
                    </div> --}}
                    <x-form.textarea title="Topik conseling" name="topikkonseling" value="Topik Counseling" placeholder="" />
                    <x-form.textarea title="Respon Counsele" name="responsekonseling" value="Repon Counsele" placeholder="" />
                    ...
                    <x-button.button-link class="btn btn-dark text-white" title="Go Back" icon="arrow-left" url="{{ route('admin.counseling.index') }}">
