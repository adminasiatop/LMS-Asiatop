...
@section('content')
     <div class="container-xl">
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4">
                <x-utilities.widget title="Events" subTitle="{{ $events }}" class="bg-danger">
            ...
            <div class="col-md-6 col-lg-4">
                <x-utilities.widget title="Coaching Identify" subTitle="{{ $identify_coachings }}" class="bg-pink">
            ...
            <div class="col-md-6 col-lg-4">
                <x-utilities.widget title="Coaching" subTitle="{{ $coachings }}" class="bg-teal">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-tags" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                        <path d="M7.859 6h-2.834a2.025 2.025 0 0 0 -2.025 2.025v2.834c0 .537 .213 1.052 .593 1.432l6.116 6.116a2.025 2.025 0 0 0 2.864 0l2.834 -2.834a2.025 2.025 0 0 0 0 -2.864l-6.117 -6.116a2.025 2.025 0 0 0 -1.431 -.593z">
                        </path>
            ...
            <div class="col-md-6 col-lg-4">
                <x-utilities.widget title="Counseling" subTitle="{{ $counselings }}" class="bg-blue">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-tags" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                        <path d="M7.859 6h-2.834a2.025 2.025 0 0 0 -2.025 2.025v2.834c0 .537 .213 1.052 .593 1.432l6.116 6.116a2.025 2.025 0 0 0 2.864 0l2.834 -2.834a2.025 2.025 0 0 0 0 -2.864l-6.117 -6.116a2.025 2.025 0 0 0 -1.431 -.593z">
                        </path>
            ...
            {{-- <div class="col-12">
                <div class="alert alert-info" role="alert">
                    ...
                    Ada <span class="text-danger">{{ $transactionVerified }}</span> CNC yang perlu di review
                     — <a href="{{ route('admin.transactions.index') }}">check it out!</a>
                </div>
            </div> --}}
            <div class="col-12">
