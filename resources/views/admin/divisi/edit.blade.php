        ...
        <div class="col-12">
            <x-card.card title="Edit divisi">
                <form action="{{ route('admin.divisi.update', $divisi->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-3">
                            <x-form.input class="col-3 col-md-3" type="text" title="NIK" name="divisiCd" value="{{ old('divisiCd', $divisi->divisiCd) }}" placeholder="Input NIK divisi" />
                        </div>
                        <div class="col-3">
                            <x-form.input class="col-3 col-md-3" type="text" title="Nama divisi" name="divisiName" value="{{ old('divisiName', $divisi->divisiName) }}" placeholder="Input Nama divisi" />
                        </div>
