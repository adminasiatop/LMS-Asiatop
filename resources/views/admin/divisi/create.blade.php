                ...
                <x-card.card title="Form Input divisi">
                    <form action="{{ route('admin.divisi.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            <div class="row">
                                <div class="col-3">
                                    <x-form.input class="col-3 col-md-3" type="text" title="Kode Divisi" name="divisiCd" value=""
                                    placeholder="Input kode divisi"/>
                                </div>
                                <div class="col-3">
                                    <x-form.input class="col-3 col-md-3" type="text" title="Nama divisi" name="divisiName" value=""
